...
\begin{tikzpicture}[node distance=2cm and 2cm]
    ...
    \node (sqlite) [database, right=2cm of pandas, text width=2cm, text centered] {Almacenamiento (SQLite)};
    
    \node (ui) [process, below=2cm of sqlite, text width=3cm] {Visualización Reactiva (Plotly)};
    \node (agent) [startstop, below=2cm of pandas, text width=3cm] {Agente de IA (Análisis Ad-Hoc)};
    ...
    \draw [arrow] (sqlite) -- node[anchor=south east, sloped] {Lectura Contextual} (agent);
